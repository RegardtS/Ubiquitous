...
public class MyWatchFace extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            mBackgroundPaint.setColor(resources.getColor(R.color.background_light));
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            Rect empty = new Rect();
            mTimePaint.getTextBounds(text, 0, text.length(), empty);

            canvas.drawText(text, bounds.centerX()-(empty.width()/2),mYOffset, mTimePaint);

            mDatePaint.getTextBounds(datetext, 0, datetext.length(), empty);
